...
import { parseStringList } from "../../src/parsers/parseStringList";
...
export default test([
	{
		...
		received: parseStringList(parseStringSecondsValue)("13,10"),
		wanted: [13, 10]
	},
	{
		given: "a valid list including a range",
		must: "return CronList",
		received: parseStringList(parseStringSecondsValue)("13-10,10"),
	...
	},
	{
		...
		must: "return CronList",
		received: parseStringList(parseStringSecondsValue)("13-10/10,10"),
		wanted: [{ every: 10, start: { from: 13, to: 10 } }, 10]
	},
	{
		given: "a valid list including a steps value with an *",
		must: "return CronList",
		received: parseStringList(parseStringSecondsValue)("*/10,10"),
		wanted: [{ every: 10, start: CRON_EVERY }, 10]
	},
	{
		given: "a valid list including invalid values",
		must: "return CronList",
		received: parseStringList(parseStringSecondsValue)("13,INVALID"),
		wanted: undefined
	},
	{
		given: "an invalid list",
		must: "return undefined",
		received: parseStringList(parseStringSecondsValue)("INVALID"),
		wanted: undefined
	}
]);
